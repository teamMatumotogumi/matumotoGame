...
void MatumotoGame::GameScene::CreateBackground(Transform* parent)
{
    ...
    GameObject::CreateWithSprite("背景1枚目", background01Texture, Rect(0, 0, 1920, 1080), Vector2(0.0f, 0.0f), 1.0f, Vector3(0, 0, 100), parent);
    // 背景2枚目
    Texture2D* background02Texture = Texture2D::FromFile(L"Assets/Stage(B)/WindowsXP - コピー.jpg");
    GameObject::CreateWithSprite("背景2枚目", background02Texture, Rect(0, 0, 1920, 1080), Vector2(0.0f, 0.0f), 1.0f, Vector3(1920, 0, 100), parent);
